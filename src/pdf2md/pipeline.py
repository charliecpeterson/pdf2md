...
@dataclass
class _Run:
    """What the last stage of a conversion needs, in one parameter.

    The stages of `convert_file` share about twenty locals, which is why this
    ...
    rearrangement. The earlier stages still run inline; this is the shape they
    should move to, one at a time, with the gate proving each.
    """
